...
class PostPhoto extends StatefulWidget {
  const PostPhoto({Key? key}) : super(key: key);
...
class _PostPhotoState extends State<PostPhoto> {
  ...
  postPhoto(BuildContext context) async {
    posting = true;
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.fromLTRB(0, 25, 15, 20),
              child: ListTile(
                leading: Container(
                  height: 50,
                  width: 50,
                ...
                subtitle: Text("Is adding a new photo"),
                dense: true,
              ),
            ),
            Padding(
